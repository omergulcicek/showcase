...
const projects = [
  { name: "Next.js Boilerplate", url: "/nextjs-boilerplate", color: "bg-blue-400" },
  ...
  { name: "Modern Web in 3 Minutes", url: "/modern-web-in-3-minutes", color: "bg-amber-300" },
];

const links = [
  { name: "Maintainers", url: "/maintainers", icon: Users },
  { name: "GitHub", url: "https://github.com/virastack", icon: Github, external: true },
  { name: "X (Twitter)", url: "https://twitter.com/omergulcicek", icon: Twitter, external: true },
];
...
export function GlobalRail() {
  ...
  return (
    <div className="hidden md:flex flex-col items-center w-14 border-r border-border/40 bg-sidebar py-4 gap-2 z-20 shrink-0">
      {/* Projects */}
