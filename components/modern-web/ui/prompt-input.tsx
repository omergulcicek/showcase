...
import {
  ...
  CommandList,
  CommandSeparator,
} from "@/components/modern-web/ui/command";
import { HoverCard, HoverCardContent } from "@/components/modern-web/ui/hover-card";
import {
  InputGroup,
  InputGroupAddon,
  InputGroupButton,
  InputGroupTextarea,
} from "@/components/modern-web/ui/input-group";
import { Menu, MenuItem, MenuTrigger } from "@/components/modern-web/ui/menu";
import { Select, SelectItem } from "@/components/modern-web/ui/select-prompt";
import { Tooltip, TooltipTrigger } from "@/components/modern-web/ui/tooltip";
...
export function PromptInputAttachment({
  ...
  return (
    <div
      className={cn(
        "group relative h-14 w-14 rounded-md border border-border",
        className,
