...
ViraMask is designed to work seamlessly with any UI library that exposes an input ref and standard events.

## shadcn/ui

You can easily integrate ViraMask with [shadcn/ui](https://ui.shadcn.com/) components.
