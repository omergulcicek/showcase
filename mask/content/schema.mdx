...
The schema is the core configuration for ViraMask. It maps your form field names to mask definitions.
...
ViraMask includes presets for common use cases.
...
- **[Mask Options](/mask-options):** Explore all available configuration options for customizing masks.
- **[Examples](/examples):** View live demos of various presets and custom configurations.
