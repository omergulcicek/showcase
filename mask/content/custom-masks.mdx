...
For low-level masking functions (like `applyMask` or `cleanValue`) that you can use outside of the hook, refer to the **[Core Functions](/api/engine)** documentation.
