...
<MaskedInputDemo preset="cvv" label="Card Security Code (CVV)" />
...
ViraMask can automatically switch the CVV mask to **4 digits** if an American Express card number is entered in another field.
