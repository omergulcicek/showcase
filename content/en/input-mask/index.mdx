...
<div className="flex gap-2 mt-4 mb-8">
  <Button size="sm" asChild>
    <a href="/input-mask/getting-started" className="no-underline">
      Getting Started
    </a>
  </Button>
  <GithubStarButton href="https://github.com/virastack/input-mask" variant="outline" size="sm" />
</div>
...
See the [Examples](/input-mask/examples) page for live demos of each preset — credit card, phone, currency, date, and more.
